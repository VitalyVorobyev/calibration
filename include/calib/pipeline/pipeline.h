...
class PipelineContext final {
    IntrinsicCalibrationConfig intrinsics_config_;
  ...
  public:
    ...
    [[nodiscard]] auto intrinsics_config() const -> const IntrinsicCalibrationConfig& {
        return intrinsics_config_;
    }
    auto intrinsics_config() -> IntrinsicCalibrationConfig& { return intrinsics_config_; }
