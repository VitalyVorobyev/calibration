...
void generate_synthetic_data(PlanarView& view, Mat3& true_H, int n_points = 50,
    ...
    true_H << c, -s, tx, s, c, ty, 0.001, -0.002, 1.0;
...
TEST(HomographyTest, InsufficientPoints) {
    ...
    PlanarView view{
        {{0.0, 0.0}, {10.0, 0.0}}, {{1.0, 0.0}, {11.0, 0.0}}, {{0.0, 1.0}, {10.0, 1.0}}};
